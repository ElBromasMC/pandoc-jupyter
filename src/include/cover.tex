...
\node at ($(current page.center)+(0,-2)$) {{\fontsize{36}{72} \selectfont Técnicas de Modelamiento - Práctica}};
\node at ($(current page.center)+(0,-4)$) {{\fontsize{24}{72} \selectfont Informe}};
\node at ($(current page.center)+(0,-5)$) {{\fontsize{20}{72} \selectfont Resolución de las EDO}};
